...
function result() {
  ...
  newStory = newStory.replace(":insertx:", xItem); /*Second replacement for the xItem*/
  ...
  if (document.getElementById("metric").checked) {
    ...
    newStory = newStory.replace("300 pounds", weight.toFixed(2) + "kg"); /* Got the .toFixed() from https://stackoverflow.com/questions/4256030/limit-the-amount-of-number-shown-after-a-decimal-place-in-javascript*/
    ...
    newStory = newStory.replace("94 Fahrenheit", temp.toFixed(2) + "°C");
  }
